...
running command...
$ srm (--version)
super-repo-manager/0.0.0 darwin-arm64 node-v20.13.1
$ srm --help [COMMAND]
USAGE
  $ srm COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/jafarijason/super-repo-manager/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/jafarijason/super-repo-manager/blob/v0.0.0/src/commands/hello/world.ts)_
